...
import { Member } from "apps/axies-api/src/libs/dto/member/member";
import { Property } from "apps/axies-api/src/libs/dto/property/property";
import {
  MemberStatus,
  MemberType,
} from "apps/axies-api/src/libs/enums/member.enum";
import { PropertyStatus } from "apps/axies-api/src/libs/enums/property.enum";
...
export class BatchService {
  ...
  public getHello(): string {
    return "Welcome to Axies BATCH Server!";
  }
}
